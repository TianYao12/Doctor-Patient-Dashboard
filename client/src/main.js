...
const Main = () => {
  ...
  return (
    <div className="app">
      {!authToken && <Auth />}{" "}
      {/* If not authenticated, render authentication component */}
      {/* If authenticated, render */}
      {authToken && (
        <>
          <Header email={userEmail} user_type={role === "Patient"} />
            ...
            <>
              <form onSubmit={handleSubmit}>
                <div className="bottom">
                  ...
                  <p>
                    {medications
                      ? medications.medication != "no medication"
